<template>
    <section
      id="home"
      ref="introRef"
      class="tw:min-h-screen tw:flex tw:flex-col tw:items-center tw:justify-center tw:relative tw:overflow-hidden tw:bg-gradient-to-br tw:from-background tw:via-muted/30 tw:to-background"
    >
